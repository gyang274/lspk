...
+ In Spark, computation operations are expressed through distributed collections that are automatically parallelized across the cluster. These collections are called __resilient distributed datasets__, or __RDDs__. RDDs are Spark's fundamental abstraction for distributed data and computation.
